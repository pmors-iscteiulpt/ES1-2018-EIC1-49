package test.mail_api;

import java.awt.Color;
import test.mail_api.MailAPI;
...
public class SentMailWindow {
	...
	private void initialize() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(SentMailWindow.class.getResource("/test/mail_api/if_list_384887 (2).png")));
